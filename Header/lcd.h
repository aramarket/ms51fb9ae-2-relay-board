#define LCD_GPIO_init()                    do{P30_PushPull_Mode;P17_PushPull_Mode;P16_PushPull_Mode;P00_PushPull_Mode; P01_PushPull_Mode; P10_PushPull_Mode; P11_PushPull_Mode; P12_PushPull_Mode; P13_PushPull_Mode;}while(0)
...
void show_value(unsigned char value,int positon,int line);